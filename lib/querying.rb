...
def select_series_title_with_most_human_characters
  "SELECT series.title, SUM(characters.species) FROM series INNER JOIN characters ON series.id = characters.series_id GROUP BY series.title HAVING characters.species = 'human' ORDER BY COUNT(characters.species) DESC;"
end
